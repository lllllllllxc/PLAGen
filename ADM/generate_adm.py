...
if os.path.exists("../data/thresholds.pkl"):
...
def main(model, image_path, seg_path, mask_path, array_path):
    ...
    mask_arr_ass = np.zeros((365, 300, 3))
    ...
    img = mask_tensor * img_tensor + 0.4 * (1-mask_tensor) * img_tensor
...
if __name__ == '__main__':
    ...
    for image_path in bar:
        seg_path = image_path.replace("images", "resnet34_300/images300_seg")
        mask_path = image_path.replace("images", "resnet34_300/images300_mask")
        array_path = image_path.replace("images", "resnet34_300/images300_array").replace(".png", ".npy")
